...
next day and getting it to run almost instantly. I gradually learned that once I start to find myself banging my head against the wall on the same problem for too long it’s better to let it simmer and come back to it later! `r tufte::quote_footer('— Student reflection')`
...
<div class="rolling-container">
  ...
  <p>🌼 <strong>Personal support</strong></p>
    ...
    <p>💬 <strong>My consultation hours</strong></p>
    <p>Mondays, Tuesdays & Fridays 1—2pm, <a href="https://maps.auckland.ac.nz/wayfinding?type=poi&selectedLocation=1000028551" target="_blank">blg 303 rm 318</a></p>
    <p>💡  <strong>Lecture Activities</strong></p>
    <p><a href="https://dub.sh/biosci220" target="_blank">dub.sh/biosci220</a></p>
    <img src="img/qr_biosci220.svg" alt="dub.sh.biosci220">
  </div>
