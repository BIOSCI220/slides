...
library(tidyverse)
data <- read_csv("img/randomisation_data.csv")
data %>%
	ggplot(., aes(x = Group, y = Value)) + geom_violin() + geom_jitter(aes(col = Group), size = 1.5) +
...
ggplot(data, aes(x = Group, y = Value)) + geom_violin() + geom_jitter(aes(col = Group), size = 1.5) +
	xlab("Group") + ylab("Value") + theme_light() +
	annotate(geom = "text", x = meds$Group, y = meds$means, label = paste("Mean = ", meds$means))  +
  scale_color_manual(values = c("#80CFF0", "#DFC0D0"))
